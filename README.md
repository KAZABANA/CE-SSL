...
* The pretrained base backbone (base_checkpoint.pkl). The medium and large backbones are available on [Hugging Face](https://huggingface.co/KAZABANA/Foundation-Models-for-ECG-classification/tree/main).
